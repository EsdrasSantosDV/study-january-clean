...
public class GetCategoryByIdUseCaseIT {
    ...
    @Test
    @DisplayName("Dado um id válido, quando chamar o caso de uso de buscar categoria, então deve retornar a categoria")
    ...
    @Test
    @DisplayName("Dado um id inválido, quando chamar o caso de uso de buscar categoria, então deve retornar erro")
    ...
    @Test
    @DisplayName("Dado um id válido, quando chamar o caso de uso de buscar categoria, então deve retornar erro")
