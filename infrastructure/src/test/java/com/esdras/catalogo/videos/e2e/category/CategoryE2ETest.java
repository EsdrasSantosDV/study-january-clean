...
public class CategoryE2ETest {
    ...
    @Test
    @DisplayName("Dado o catologo e se ele esta habilidato a dar um update na categoria atraves do identificador")
    ...
    @Test
    @DisplayName("Dado o catologo e se ele esta habilidato a inativar a categoria atraves do identificador")
    ...
    @Test
    @DisplayName("Dado o catologo e se ele esta habilidato a deletar a categoria atraves do identificador")
