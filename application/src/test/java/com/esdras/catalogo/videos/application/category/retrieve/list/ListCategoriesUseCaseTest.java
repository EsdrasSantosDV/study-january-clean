...
class ListCategoriesUseCaseTest {
    ...
    @Test
    @DisplayName("Dados uma query validar, quando chamar o método execute, então deve retornar a paginação de categoria")
    ...
    @Test
    @DisplayName("Dados uma query validar, quando chamar o método execute, então deve retornar uma paginação vazia de items")
    ...
    @Test
    @DisplayName("Dados uma query válida, quando chamar o chamar o gateway, então deve retornar uma exceção")
